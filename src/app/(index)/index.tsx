    ...
    >
      <View style={{ padding: 20, gap: 32, alignItems: "center", backgroundColor: bgColor }}>
          ...
          >
            ...
            <Image
              ...
              style={{
                ...
                height: 30,
                tintColor: isDarkMode ? "#F5F5F5" : "#2C2C2C"
              }}
              contentFit="contain"
            />
          </Pressable>
        ...
        <Modal
          ...
          transparent={true}
          animationType="fade"
          onRequestClose={() => setShowTimeSignature(false)}
        >
          <Pressable
            style={{
              flex: 1,
            ...
            onPress={() => setShowTimeSignature(false)}
          >
            <View
              style={{
        ...
        <Modal
          ...
          transparent={true}
          animationType="fade"
          onRequestClose={() => setShowSubdivision(false)}
        >
          <Pressable
            style={{
              flex: 1,
            ...
            onPress={() => setShowSubdivision(false)}
          >
            <View
              style={{
                backgroundColor: isDarkMode ? "#1c1c1e" : "white",
                    ...
                    >
                      <Image
                        ...
                        style={{
                          ...
                          height: 35,
                          tintColor: sub === subdivision ? "white" : (isDarkMode ? "#F5F5F5" : "#2C2C2C")
                        }}
                        contentFit="contain"
                      />
                    </Pressable>
